...
function FoodCard({ data, index }) {
  ...
  return (
    <div className="w-62.5 rounded-2xl border-2 border-[#ff4d2d] bg-white shodow-md overflow-hidden hover:shadow-xl transition-all duration-300 flex flex-col">
      ...
      <div className="flex flex-col flex-1 p-4">
        <h1 className="font-semibold text-shadow-gray-900 text-base truncate">
          {data.name}
        </h1>
